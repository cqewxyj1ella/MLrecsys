...
class ModelEvaluator:
    ...
    def __init__(self, train_df, interactions_full_indexed_df, interactions_test_indexed_df, interactions_train_indexed_df):
    ...
    def get_not_interacted_items_sample(self, person_id, sample_size, seed=42):
        ...
        all_items = set(self.train_df['product_id'].unique())
